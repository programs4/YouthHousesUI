<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Modules_Administrators_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">
    ...
    <asp:Panel ID="pnlFilter" runat="server" CssClass="filter">
        <div class="row">
            <div class="col-md-2">
                №:
                <asp:TextBox ID="txtAdministratorsId" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            ...
            <div class="col-md-2">
                Status:
                <asp:DropDownList ID="dListAdministratorsStatus" runat="server" DataValueField="ID" DataTextField="Name" CssClass="form-control">
                </asp:DropDownList>
            </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <asp:Panel ID="PnlAddSurveys" runat="server" CssClass="addNews">
                <a href='<%=$"/{Langs.Name}/modules/administrators/operations/add/0" %>'>
    ...
    <br />
    <asp:GridView ID="grdAdministrators" runat="server" AutoGenerateColumns="False" BorderColor="#ebedf3" BorderWidth="1px" CellPadding="4" ForeColor="#051615" Width="100%" Font-Bold="True">
        <Columns>
            ...
            <asp:BoundField DataField="OrganizationsName" HeaderText="Qurum">
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle HorizontalAlign="Left" />
            </asp:BoundField>

            <asp:BoundField DataField="Fullname" HeaderText="Tam adı">
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle HorizontalAlign="Left" Width="350px" />
            </asp:BoundField>

            <asp:BoundField DataField="Position" HeaderText="Vəzifəsi">
                <HeaderStyle HorizontalAlign="Left" />
            ...
            <asp:BoundField DataField="AdministratorsStatusName" HeaderText="Statusu">
                <HeaderStyle HorizontalAlign="Left" />
                <ItemStyle HorizontalAlign="Left" Width="120px" />
            </asp:BoundField>
            ...
            <asp:TemplateField HeaderText="Düzəliş">
                <ItemTemplate>
                    <a href="/<%=Langs.Name%>/modules/administrators/operations/edit/<%#Eval("Id")%>">
    ...
    <script type="text/javascript">
        function GetPagination(t, p) {
            $('.pager_top').bootpag({
                ...
                window.location.href = '/<%=Langs.Name%>/modules/administrators/' + num;
            }).find('.pagination');
        }
