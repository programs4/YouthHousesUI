<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ReportUseServicesForOrganizations.ascx.cs" Inherits="Modules_Reports_UserControls_ReportUseServicesForOrganizations" %>
