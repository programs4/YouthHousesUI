...
public partial class Modules_Reports_UserControl_ReportUseServicesForAge : System.Web.UI.UserControl
{
    ...
    private void BindReports()
    {
        ...
        dtReports = DALC.GetDataTableBySqlCommand("ReportUseServicesForAge",
                                                   "OrganizationsID,ServicesSessionsStatusId,Date1,Date2",
                                                   new object[] { dListOrganizations.SelectedValue, servicesSessionsStatus, date1, date2 }, CommandType.StoredProcedure);
