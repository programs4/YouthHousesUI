...
public partial class Modules_Reports_UserControls_ReportUseServicesForOrganizations : System.Web.UI.UserControl
{
    private void BindReports()
    {
        ...
        dtReports = DALC.GetDataTableBySqlCommand("ReportUseServicesForOrganizations",
                                                   "LangsId,OrganizationsID,ServicesSessionsStatusId,Date1,Date2",
                                                   new object[] { (int)Tools.Langs.AZ, dListOrganizations.SelectedValue, "20,30", date1, date2 }, CommandType.StoredProcedure);
