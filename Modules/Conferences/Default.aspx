<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Modules_Conferences_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" runat="Server">  
        ...
        <div class="row">
            <div class="col-md-6">
                <asp:Panel ID="PnlAddServices" runat="server" CssClass="addNews">
                    <a href='<%=$"/{Langs.Name}/modules/conferences/operations/add/0" %>'>
        ...
        <br />
        <asp:GridView ID="grdSrvices" runat="server" AutoGenerateColumns="False" DataKeyNames="ID,ServicesName" BorderColor="#ebedf3" BorderWidth="1px" CellPadding="4" ForeColor="#051615" Width="100%" Font-Bold="True">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Tarix">
                    ...
                    <ItemStyle Width="120px" Font-Size="11pt" />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Düzəliş">
                    <ItemTemplate>
                        <a href="/<%=Langs.Name%>/modules/conferences/operations/edit/<%#Eval("ServicesId")%>">
